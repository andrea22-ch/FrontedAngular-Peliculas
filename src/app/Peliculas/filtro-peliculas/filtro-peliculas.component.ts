...
export class FiltroPeliculasComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder , private location:Location,private activetedRoute:ActivatedRoute) { }
  form:FormGroup;
  peliculas = [
...
formularioOriginal={
  ...
  ngOnInit(): void {
    ...
    //un valuechange retorna un observable, subcribe captura los datos
  ...
  private escribirParametrosBusquedaEnUrl(){
    ...
    if(valoresFormulario.generoId){
      queryString.push(`generoId=${valoresFormulario.titulo}`);
    }
    if(valoresFormulario.proximosEstrenos){
      queryString.push(`proximosEstrenos=${valoresFormulario.titulo}`);
    }
